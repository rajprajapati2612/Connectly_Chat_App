 ...
 scroll?.current.scrollIntoView({behavior:"smooth"})
  ...
  return (
    <div  className='flex items-start gap-1'>
     ...
     <div ref={scroll}  className='w-fit max-w-125 px-5 py-2 bg-[#589b99] text-white text-5 rounded-tl-none rounded-2xl relative left-0 shadow-gray-400 shadow-lg gap-2.5 flex flex-col break-words whitespace-pre-wrap'>

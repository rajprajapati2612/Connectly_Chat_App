...
const SenderMessage = ({image,message}) => {
 ...
 scroll?.current.scrollIntoView({behavior:"smooth"})
  ...
  <div ref={scroll} className='w-fit max-w-125 px-5 py-2 bg-[#00c7c4] text-white text-5 rounded-tr-none rounded-2xl relative right-0 ml-auto shadow-gray-400 shadow-lg gap-2.5 flex flex-col break-words whitespace-pre-wrap'>

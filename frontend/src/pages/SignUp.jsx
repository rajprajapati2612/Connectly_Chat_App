  ...
  return (
    <div className='w-full h-screen bg-slate-200 flex justify-center items-center '>
      ...
      <form className='w-full flex flex-col gap-7 items-center'>
        <input type="text" placeholder='username' className='w-[90%] h-[90%] outline-none border-3 border-[#00c7c4] px-5 py-2.5 bg-white rounded-lg shadow-gray-400 shadow-lg' />
        ...
        <button className=' transition-all px-8 py-3 bg-[#00c7c4] rounded-3xl shadow-gray-400 shadow-lg font-bold text-gray-200 text-[20px] w-50 hover:shadow-inner'>Sign up</button>
